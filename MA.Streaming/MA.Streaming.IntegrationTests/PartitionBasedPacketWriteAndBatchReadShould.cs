// <copyright file="PartitionBasedPacketWriteAndBatchReadShould.cs" company="McLaren Applied Ltd.">
//
...
public class PartitionBasedPacketWriteAndBatchReadShould : IClassFixture<KafkaTestsCleanUpFixture>
{
