// <copyright file="NewSessionPacketDtoFromByteFactory.cs" company="McLaren Applied Ltd.">
//
...
public class NewSessionPacketDtoFromByteFactory : IDtoFromByteFactory<NewSessionPacketDto>
{
    private readonly ILogger apiLogger;

    public NewSessionPacketDtoFromByteFactory(ILogger apiLogger)
    {
        this.apiLogger = apiLogger;
    }

    public NewSessionPacketDto? ToDto(byte[] content)
    {
        try
        {
