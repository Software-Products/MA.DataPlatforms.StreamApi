// <copyright file="TopicBasedConsumingConfigurationProvider.cs" company="McLaren Applied Ltd.">
//
...
public class TopicBasedConsumingConfigurationProvider : BaseConsumingConfigurationProvider
{
    private readonly ITopicBaseTopicNameCreator topicBaseTopicNameCreator;

    public TopicBasedConsumingConfigurationProvider(
    ...
    protected override KafkaRoute GetStreamRoute(string stream)
    {
        ...
        return new KafkaRoute(
            ...
            this.topicBaseTopicNameCreator.Create(this.ConnectionDetailsDto.DataSource, stream));
    }
}
